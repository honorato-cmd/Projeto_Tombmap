...
import 'package:tombmap/views/android/pages/admin/confirmaemail.dart';
...
import 'package:tombmap/views/android/pages/admin/onlyadmin.dart';
import 'package:tombmap/views/android/pages/inicial.dart';
import 'package:tombmap/views/android/pages/users/Falecidos.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/confirmaemail': (context) => ConfirmaEmail(),
        '/onlyadmin': (context) => OnlyAdmin(),
        '/falecidos': (context) => Falecidos(),
      },
    );
  }
}
