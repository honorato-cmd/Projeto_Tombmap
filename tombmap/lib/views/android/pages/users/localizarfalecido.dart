...
class LocalizadorFalecido extends StatefulWidget {
  ...
  LocalizadorFalecido({this.nomezinho, this.lapidinha});
...
class _LocalizadorFalecidoState extends State<LocalizadorFalecido> {
  ...
  var lapide = new TextEditingController();
  ...
  void Definicao () async {
    print(widget.lapidinha);
    print(widget.lapidinha);
    if (widget.nomezinho != null || widget.lapidinha != null) {
      nome.text = widget.nomezinho!; 
      lapide.text = widget.lapidinha!;
    }
  }
                  ...
                  child: ClipOval(
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          Navigator.of(context).pushNamed('/falecidos');
                        },
                      ),
                    ),
                  ),
